...
if if_ddp:
    train_config = TrainConfig(learning_rate = 6e-4, weight_decay = 0.1, beta1 = 0.9, 
                        beta2 = 0.95, device = my_device, n_batch = 60, n_minibatch = 1, 
                        ...
                        log_interval = 1000, check_point_interval = 1000, out_dir = 'out')
    ...
    train_config = TrainConfig(learning_rate = 6e-4, weight_decay = 0.1, beta1 = 0.9, 
                        beta2 = 0.95, device = my_device, n_batch = 60, n_minibatch = 6, 
                        it_max = 600000, it_warmup = 2000, it_learning_rate_decay = 600000, 
                        learning_rate_min = 6e-5, if_learning_rate_decay = True, grad_clip = 1.0, 
                        log_interval = 1, check_point_interval = 1000, out_dir = 'out')
